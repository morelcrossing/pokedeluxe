...
PalPacket_OverworldSprites: PAL_SET 0, 0, 0, 0
PalPacket_PartyMenu2:       PAL_SET PAL_PARTY_GENDER, PAL_BATTLETEXT2, PAL_TEXTBOX, PAL_TEXT
PalPacket_BattleText:       PAL_SET PAL_BATTLETEXT1, PAL_BATTLETEXT2, PAL_TEXTBOX, PAL_TEXT
...
PalPacket_RedsHouse1:       PAL_SET PAL_REDSHOUSE_1, PAL_REDSHOUSE_2, PAL_REDSHOUSE_3, PAL_REDSHOUSE_4
PalPacket_RedsHouse2:       PAL_SET PAL_REDSHOUSE_5, PAL_REDSHOUSE_6, PAL_TEXTBOX, PAL_TEXT
PalPacket_Pokecenter1:      PAL_SET PAL_POKECENTER_1, PAL_POKECENTER_2, PAL_POKECENTER_3, PAL_POKECENTER_4
PalPacket_Pokecenter2:      PAL_SET PAL_POKECENTER_5, PAL_POKECENTER_6, PAL_TEXTBOX, PAL_TEXT
PalPacket_Pokemart1:        PAL_SET PAL_POKEMART_1, PAL_POKEMART_2, PAL_POKEMART_3, PAL_POKEMART_4
PalPacket_Pokemart2:        PAL_SET PAL_POKEMART_5, PAL_POKEMART_6, PAL_TEXTBOX, PAL_TEXT
